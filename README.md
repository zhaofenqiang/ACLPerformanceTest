...
# Performance  
Due to these issues [#354](https://github.com/ARM-software/ComputeLibrary/issues/354), [#356](https://github.com/ARM-software/ComputeLibrary/issues/354), there are still some problems with running cnn by graph API on ACL.
